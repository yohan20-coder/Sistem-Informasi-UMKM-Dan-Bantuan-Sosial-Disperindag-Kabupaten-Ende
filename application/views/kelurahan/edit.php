...
<div class="container-fluid">
         ...
         <div class="row">
            ...
            <form action="<?= base_url();?>kelurahan/edit/<?= $edit['kode'] ?>" method="post">
              ...
              <div class="form-group row">
                    <label for="nokk" class="col-sm-2 col-form-label">Nama Kecamanatan</label>
                    <div class="col-sm-10">
                        <select name="kec" id="kec"  class="js-example-basic-single">
                        <option value=""></option>
                            <?php foreach($tam as $m): ?>
                                <option value="<?= $m['kecamatan'] ?>"
                                <?php if($m['kecamatan'] == $edit['kecamatan']){
                                    echo 'selected';
                                    }?>
                                ><?= $m['kecamatan'] ?></option>
                            <?php endforeach; ?>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="kel" value="<?= $edit['kelurahan'];?>">
