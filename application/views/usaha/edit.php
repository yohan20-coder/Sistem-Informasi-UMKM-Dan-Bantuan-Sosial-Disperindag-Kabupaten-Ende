...
<div class="container-fluid">
        ...
        <form action="<?= base_url();?>usaha/edit/<?= $edit['id'] ?>" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="usaha" value="<?= $edit['nm_usaha'];?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama" value="<?= $edit['pemilik'];?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="hp" value="<?= $edit['hp'];?>">
